...
class PlayingCardView: UIView {
    ...
    // If values has changed, redraw self.view and child views.
    ...
    override func draw(_ rect: CGRect) {
       drawRectWithBazierPath() 
    }
    
    func drawCircleWithBezierPath(){
    ...
    func drawCircleWithGraphicContext() {
    ...
    private func centeredAttributedString(_ string: String, fontSize: CGFloat) -> NSAttributedString {
        ...
        font = UIFontMetrics(forTextStyle: .body).scaledFont(for: font) // Scale our fonts if user scale fonts trhought settings.
